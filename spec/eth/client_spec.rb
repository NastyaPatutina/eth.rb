...
describe Client do
  ...
  describe ".deploy .deploy_and_wait" do
    ...
    it "can deploy and call an ens registry" do
      ...
      ens_address = geth_dev_ipc.deploy_and_wait(ens_registry, Eth::Constant::NULL_ADDRESS)
  ...
  describe ".is_valid_signature" do
    ...
    subject(:contract) { Contract.from_file(file: "spec/fixtures/contracts/signer.sol", contract_name: 'Signer') }
    let(:magic) { "1626ba7e" }
